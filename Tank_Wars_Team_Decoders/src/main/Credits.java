...
public class Credits extends JComponent {
	...
	public static int loop = 1850; // needs to be 610+ highest number to the
									// last name; 1550 for Fall 2011
	...
	public static synchronized void draw(Graphics g) {
		...
		g.drawString("Programmer   --------- Benjamin Beattie-Chapnick", x,
				(y + 440));
		g.drawString("Programmer   --------- Kaitlyn Boresky", x, (y + 460));
		g.drawString("Programmer   --------- Taylor Busch", x, (y + 480));
		g.drawString("Programmer   --------- Sarah Samantha Canieso", x,
				(y + 500));
		...
		g.drawString("Programmer   --------- George Panagopoulos", x,
				(y + 1215));
		...
		if (loop - count > 2) {
			g.setFont(new Font("SansSerif", Font.BOLD, 20));
			g.drawString("Press Escape", x + 50, (y + 1540));// needs to be 300+
																// highest
																// number to the
																// last name;
																// 1240 for Fall
			...
			g.drawString("ROCK ON!", x + 55, (y + 1540));// needs to be 300+
															// highest number to
															// the last name
		}
